...
Use this code to make a preview:import { useEffect, useRef } from "react";
...
    let showDoubleJumpUnlock = false;
...
    // Challenge levels are twice as long with triple spikes and tall spikes.

    // Tall spikes are 40 px high (two stacked) and drawn in orange — a single

    // well-timed jump barely clears them; the double jump makes it easy.

    // Triple spikes are three adjacent spikes (same gap as doubles).

    // All previous obstacle types (singles, doubles) are kept.
...
      // Split the track into thirds so each obstacle type is spread out.
...
        // Double jump is only available in challenge mode (levels 6-10).
...
          // Tall spike occupies y=[210,250]; player clears it when playerY≥38.

          // Regular spike occupies y=[230,250]; player clears when playerY≥18.
...
**Live app**: https://the-jumping-game.lovable.app

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/57617c35-d1ed-490d-814a-4ee6c66538ce).
